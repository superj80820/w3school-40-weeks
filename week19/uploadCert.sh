...
aws iam upload-server-certificate --server-certificate-name $DOMAIN --certificate-body file://cert.pem --certificate-chain file://fullchain.pem --private-key file://privkey.pem